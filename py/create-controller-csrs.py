"""Takes a json-formatted terraform output as std input and creates certificate signing requests for each worker node. The filenames are the full hostnames passed to cfssl for each instance.
...
for idx, node in enumerate(nodes):
  ...
  # save temporary interpolated csr file
